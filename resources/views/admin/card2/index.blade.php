                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="{{route('admin.cardTwo.store')}}" method="POST"
                        ...
                        <div class="body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        @foreach (App\Models\CardTwo::all() as $key => $card)
                                        <tr role="row">
                                            <td>{{ $key+1 }}</td>
...
<script>
    $(document).ready(function(){
        $('body').on('click','.editCategory',function(){
            ...
            $('#updateCardForm').attr('action','{{route('admin.cardTwo.update','')}}'+'/'+cardId);
        }); 
        $('body').on('click','.deleteCategory',function(){
            let cardId = $(this).attr('cardId');
            $('#deleteCardForm').attr('action','{{route('admin.cardTwo.destroy','')}}'+'/'+cardId);
        });
    });
</script>
